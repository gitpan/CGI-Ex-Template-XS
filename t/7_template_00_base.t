...
7_template_00_base.t - Test the basic language functionality of CGI::Ex::Template::XS - including many edge cases

=cut

use vars qw($module $is_tt);
BEGIN {
    $module = 'CGI::Ex::Template::XS'; #real    0m0.885s #user    0m0.432s #sys     0m0.004s
